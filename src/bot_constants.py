...
X_SOURCE_DISPLAY_NAME = "X(구 트위터)"
LEGACY_X_SOURCE_DISPLAY_NAME = "X(트위터)"
HAMPANG_REWRITE_HISTORY_LIMIT = 100
LEGACY_X_DISPLAY_REWRITE_SLEEP_SECONDS = 5.25
LEGACY_X_NEWS_REWRITE_MAX_AGE_DAYS = 30
HAMPANG_YOUTUBE_TITLE_MARKER = "hamhampangpang"
HAMPANG_AUTO_POLL_INTERVAL_SECONDS = 30
...
IMAGE_FAILED_URL_RETRY_AFTER_SECONDS = 15 * 60
STEAM_SYNC_FAILURE_LOG_COOLDOWN_SECONDS = 10 * 60
STALE_NEWS_LOG_CACHE_MAX_ITEMS = 512
DISCORD_VIDEO_UPLOAD_MAX_BYTES = 23 * 1024 * 1024
TWITTER_VIDEO_PROBE_TIMEOUT_SECONDS = 15
TWITTER_VIDEO_SIZE_CACHE_MAX_ITEMS = 256
TEST_MODE_GUILD_ID = 1470006115893907569
TEST_MODE_CHANNEL_ID = 1550837720505516192
...
NEWS_SOURCE_CHOICES = [
    app_commands.Choice(name="Steam & X(구 트위터)", value=NEWS_SOURCE_BOTH),
    app_commands.Choice(name="Steam", value=NEWS_SOURCE_STEAM),
    app_commands.Choice(name="X(구 트위터)", value=NEWS_SOURCE_TWITTER),
]
...
HAMPANG_SOURCE_CHOICES = [
    app_commands.Choice(name="X(구 트위터) & YouTube", value=HAMPANG_SOURCE_BOTH),
    app_commands.Choice(name="X(구 트위터)", value=HAMPANG_SOURCE_X),
